use crate::consts::KX2;

const fn add(a: [u64; 2], b: [u64; 2]) -> [u64; 2] {
    [a[0].wrapping_add(b[0]), a[1].wrapping_add(b[1])]
}

const fn sha512load(v0: [u64; 2], v1: [u64; 2]) -> [u64; 2] {
    [v1[1], v0[0]]
}
...
fn sha512_digest_block_u64(state: &mut [u64; 8], block: &[u64; 16]) {
    let k = &KX2;
...
pub fn compress(state: &mut [u64; 8], blocks: &[[u8; 128]]) {
    ...
    for block in blocks {
        ...
        sha512_digest_block_u64(&mut state_copy, &block_u64);
    }
    *state = state_copy;
}
