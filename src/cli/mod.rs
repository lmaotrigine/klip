...
impl Cli {
    fn try_parse() -> Result<Self, clap::Error> {
        // let mut cmd = defs::app();
        // for generator in <clap_complete::Shell as clap::ValueEnum>::value_variants() {
        //     clap_complete::generate_to(*generator, &mut cmd, "klip", "completions").expect("nope?");
        // }
